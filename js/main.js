...
var configs = (function () {
    ...
    Singleton.defaultOptions = {
        ...
        gtav_general_cmds_help: "Please type !cmds in the chat for GTA V Online commands.",
...
var main = (function () {
    ...
    var gtav_general_cmds = {
        MONEY: { value: "GENERAL", help: configs.getInstance().gtav_general_cmds_money_help },
    ...
    var gtav_weather_cmds = {
        WEATHERDAY: { value: "!weather day", help: configs.getInstance().gtav_weather_cmds_weatherday_help },
        OWEATHERNIGHT: { value: "!weather night", help: configs.getInstance().gtav_weather_cmds_weathernight_help },
    };
    ...
    Terminal.prototype.cat = function (cmdComponents) {
        ...
        if (cmdComponents.length <= 1) {
            ...
            result = cmdComponents[1] === configs.getInstance().welcome_file_name ? configs.getInstance().welcome : files.getInstsance()[cmdComponents[1]];
        }
